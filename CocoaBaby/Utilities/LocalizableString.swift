...
struct LocalizableString {
    ...
    static let onlyMomCanShare: String = NSLocalizedString("Alert.OnlyMomCanShare", comment: "")
    static let shareCodeMessage: String = NSLocalizedString("Alert.ShareCodeMessage", comment: "")
    static let pleaseRetryMessage: String = NSLocalizedString("Alert.PleaseRetry", comment: "")
    static let onlyFatherCanLinkWithMom: String = NSLocalizedString("Alert.OnlyFatherCanLinkWithMom", comment: "")
    static let enterCodeTitle = NSLocalizedString("Alert.EnterCodeTitle", comment: "")
    static let enterCodeMessage = NSLocalizedString("Alert.EnterCodeMessage", comment: "")
    static let linkSuccess = NSLocalizedString("Alert.LinkSuccess", comment: "")
    ...
    static let pleaseAllowNotification = NSLocalizedString("Alert.PleaseAllowNotification", comment: "")
